// src/inestabilidad-rotuliana.jsx
...
import { INESTABILIDAD_ROTULIANA_CONTENT as PAGE } from './content/pathologies/inestabilidad-rotuliana.content.jsx';
...
export default function InestabilidadRotulianaPage() {
  ...
  return (
    <Article>
      <JsonLd id="ld-inestabilidad-webpage" data={WEBPAGE_SCHEMA} />
      <JsonLd id="ld-inestabilidad-article" data={ARTICLE_SCHEMA} />
      {FAQ_SCHEMA && <JsonLd id="ld-inestabilidad-faq" data={FAQ_SCHEMA} />}
