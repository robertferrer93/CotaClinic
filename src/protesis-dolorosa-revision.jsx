...
import { PROTESIS_DOLOROSA_REVISION_CONTENT as PAGE } from './content/pathologies/protesis-dolorosa-revision.content.jsx';
...
export default function ProtesisDolorosaRevisionPage() {
  ...
  return (
    <Article>
      <JsonLd id="ld-protesis-dolorosa-webpage" data={WEBPAGE_SCHEMA} />
      <JsonLd id="ld-protesis-dolorosa-article" data={ARTICLE_SCHEMA} />
      {FAQ_SCHEMA && <JsonLd id="ld-protesis-dolorosa-faq" data={FAQ_SCHEMA} />}
