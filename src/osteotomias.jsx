...
import { OSTEOTOMIAS_CONTENT as PAGE } from './content/pathologies/osteotomias.content.jsx';
...
export default function OsteotomiasPage() {
  ...
  return (
    <Article>
      <JsonLd id="ld-osteotomias-webpage" data={WEBPAGE_SCHEMA} />
      <JsonLd id="ld-osteotomias-article" data={ARTICLE_SCHEMA} />
      {FAQ_SCHEMA && <JsonLd id="ld-osteotomias-faq" data={FAQ_SCHEMA} />}
