...
import { ROBOTICA_CONTENT as PAGE } from './content/pathologies/robotica.content.jsx';
...
export default function RoboticaPage() {
  ...
  return (
    <Article>
      <JsonLd id="ld-robotica-webpage" data={WEBPAGE_SCHEMA} />
      <JsonLd id="ld-robotica-article" data={ARTICLE_SCHEMA} />
      {FAQ_SCHEMA && <JsonLd id="ld-robotica-faq" data={FAQ_SCHEMA} />}
      ...
      <section className="border-t border-neutral-200 pt-6 mt-6">
        <h2 className="text-2xl font-semibold text-cota-slate">{PAGE.faqTitle}</h2>
      ...
      {/* Relacionado (solo prótesis + prótesis dolorosa) */}
      {PAGE.related?.length ? (
