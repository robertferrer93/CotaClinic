...
export default function LCAPage() {
  ...
  return (
    <Article>
      <JsonLd id="ld-lca-webpage" data={WEBPAGE_SCHEMA} />
      <JsonLd id="ld-lca-article" data={ARTICLE_SCHEMA} />
      {FAQ_SCHEMA && <JsonLd id="ld-lca-faq" data={FAQ_SCHEMA} />}
      ...
      <header className="mb-10">
        ...
        <p className="mt-4 text-sm text-neutral-500">
          ...
          10/12/2025 · Última revisión 25/02/2026
        </p>
